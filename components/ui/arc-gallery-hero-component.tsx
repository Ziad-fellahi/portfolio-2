...
export const ArcGalleryHero: React.FC<ArcGalleryHeroProps> = ({
  ...
  return (
    <section className={`relative overflow-hidden bg-[#F9F9FB] text-gray-900 min-h-screen flex flex-col ${className}`}>
        ...
        <div className="absolute left-1/2 bottom-0 -translate-x-1/2">
          ...
          {images.map((src, i) => {
            ...
            return (
              ...
              >
                <div 
                  className="rounded-2xl shadow-xl overflow-hidden ring-1 ring-[#EDEDF2] bg-white transition-transform hover:scale-105 w-full h-full flex items-center justify-center p-4"
                ...
                >
                  <img
                    ...
                    onError={(e) => {
                      (e.target as HTMLImageElement).src = `https://placehold.co/400x400/F9F9FB/575757?text=Code`;
                    }}
                  />
                </div>
              </div>
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center px-6 -mt-64 md:-mt-80 lg:-mt-96">
        {children}
      </div>
